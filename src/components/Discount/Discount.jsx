    ...
    <section className='bg-zinc-100 bg-no-repeat bg-right bg-contain' style={{backgroundImage: `url(${FreshFruits})`}}>
        <div className='md:bg-transparent bg-zinc-100 flex md:flex-row flex-col max-w[1200px] mx-auto px-10 py-10'>
            ...
            <div className='max-w-[700px]'>
                ...
                <p className='text-zinc-600 my-6'>Enjoy an exclusive first order discount on our grocery website! Shop fresh essentials and save big on your purchase. Fast delivery and quaranteed.</p>
