...
const Process = () => {
    ...
    const renderSteps = steps.map(item => {
        return (
            <div key={item.id} className={`flex-1 basis-[300px] ${item.id % 2 === 0 ? 'md:-mt-[120px]' : 'mt-[30px]'}`}>
...
return (
    <section>
        <div className='max-w-[1400px] mx-auto px-10 py-20'>
            ...
            <div className='flex flex-wrap gap-y-17 item-center justify-center md:mt-20 mt-10 md:pt-30'>
                {renderSteps}
            </div>
        </div>
    </section>
