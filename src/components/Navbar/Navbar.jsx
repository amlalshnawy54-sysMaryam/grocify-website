            ...
            <nav className='max-w-[1200px] mx-auto px-10 md:h-[14vh] h-[12vh] flex justify-between items-center'>
                ...
                <div className='flex items-center gap-x-5'>
                    ...
                    <div className='md:flex p-1 border-2 border-orange-500 rounded-full hidden'>
                        ...
                        <button className='bg-gradient-to-b from-red-600 to-orange-500 text-white w-10 h-8 flex justify-center items-center rounded-full text-xl'>
                            <IoSearch />
                        </button>
                    </div>
                ...
                {/* Mobile Menu */}
                <ul className={`flex flex-col gap-y-12 bg-orange-500/15 backdrop-blur-xl shadow-xl rounded-xl p-10 items-center gap-x-15 md:hidden absolute top-25 -left-full transform -translate-x-1/2 transition-all duration-500 ${showMenu ? 'left-1/2' : ""}`}>
                    <li>
                        <a href="#" className='font-semibold tracking-wider text-orange-500'>Home</a>
                    </li>
                    <li>
                    ...
                    <li className='flex p-1 border-2 border-orange-500 rounded-full md:hidden'>
                        <input type="text" name="text" id="text" placeholder='Search...' autoComplete='off'
                            className='flex-1 h-[5vh] px-3 focus:outline-none' />
                        <button className='bg-gradient-to-b from-orange-400 to-orange-500 text-white w-10 h-8 flex justify-center items-center rounded-full text-xl'>
                            <IoSearch />
                        </button>
                    </li>
